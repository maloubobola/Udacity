...
public class TodayScoresService extends RemoteViewsService {
    private static final String TAG = TodayScoresService.class.getSimpleName();
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            private void setRemoteContentDescription(RemoteViews views, String description) {
                views.setContentDescription(R.id.list_item, description);
            }
        };
    }
}
